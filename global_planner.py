...
# making binary
threshold_value = 220
_, inverted_binary_map = cv2.threshold(gray_image, threshold_value, 255, cv2.THRESH_BINARY)

grid = cv2.bitwise_not(inverted_binary_map)

# Define parameters
start = np.array([264, 345])  # Starting point
goal = np.array([635, 336])  # Goal point
